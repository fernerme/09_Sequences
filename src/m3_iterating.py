...
def run_test_count_negatives():
    ...
    # Test 6:
    expected = 4
    actual = count_negatives([0, -1, 2, -3, 4, -5, -6])
    print()
    ...
    # Test 7:
    expected = 3
    actual = count_negatives((-6, -87, -49, 3, 9))
    print()
...
def run_test_count_short_ones():
    ...
    # Test 8:
    expected = 5
    seq = ['i', 'REALLY', 'love', 'cats', '&', 'that', 'is', 'important', 'for', 'cats', 'to', 'know', '!']
    actual = count_short_ones(seq)
    print()
